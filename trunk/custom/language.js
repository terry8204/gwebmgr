    ...
    var messages = {
        ...
        zh: {
            ...
            videoSettings:{
                ...
                videoPlayParameter:'传输模式',
                videoPlayParameter:'实时性',
                videoPlayParameter:'主码流(清晰)',
                videoPlayParameter:'子码流(流畅)',
                videoPlayParameter:'对讲通道',
                videoPlayParameter:'回放音频格式',
                videoPlayParameter:'指定上传文件名',
                videoPlayParameter:'视频时间戳',
                videoPlayParameter:'设备计算',
                videoPlayParameter:'服务器计算',
                videoPlayParameter:'视频播放个数',
                videoPlayParameter:'视频',
                videoPlayParameter:'音频',
                videoPlayParameter:'音视频',
                videoPlayParameter:'通道1',
                videoPlayParameter:'通道2',
                videoPlayParameter:'通道3',
                videoPlayParameter:'通道4',
                videoPlayParameter:'通道5',
                videoPlayParameter:'通道6',
                videoPlayParameter:'通道7',
                videoPlayParameter:'通道8',
                videoPlayParameter:'设置视频播放参数',
                videoPlayParameter:'音视频参数',
                videoPlayParameter:'默认参数',
                videoPlayParameter:'实时流编码模式',
                videoPlayParameter:'存储流编码模式',
                videoPlayParameter:'实时流分辨率',
                videoPlayParameter:'存储流分辨率',
                videoPlayParameter:'实时流关键帧间隔',
                videoPlayParameter:'存储流关键帧间隔',
                videoPlayParameter:'实时流目标帧率',
                videoPlayParameter:'存储流目标帧率',
                videoPlayParameter:'实时流目标码率',
                videoPlayParameter:'存储流目标码率',
                videoPlayParameter:'OSD 字幕叠加设置',
                videoPlayParameter:'通道8',
                videoPlayParameter:'通道8',
                videoPlayParameter:'通道8',
                videoPlayParameter:'通道8',

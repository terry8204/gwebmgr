(function($){
    ...
    */
    window.wxc.xcConfirm = function(title,popHtml,type, options) {
        ...
        var $ttBox = $("<div>").addClass("ttBox").html(title);//弹窗顶部区域
    ...
    window.wxc.xcConfirm.typeEnum = {
		...
		function loading(){
			var $loadingBox = $("<div>").addClass("loading-box");//弹窗插件容器
			var $loading    = $("<div>").addClass("loading");//弹窗插件容器
				for(var i = 0; i < 5; i++)
				{
